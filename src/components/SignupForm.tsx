                  ...
                  render={({ field }) => (
                    <FormItem className='grid gap-3'>
                      ...
                      <FormControl>
                        ...
                        >
                          <Label
                            className='h-[34px] w-full grid place-items-center rounded-s-sm text-muted-foreground 
                          hover:text-foreground has-checked:bg-secondary has-checked:bg-secondary 
                          ...
                          <Label
                            className='h-[34px] w-full grid place-items-center rounded-e-sm text-muted-foreground 
                          hover:text-foreground has-checked:bg-secondary has-checked:bg-secondary 
                          has-checked:text-secondary-foreground'
                          >
                            <RadioGroupItem
